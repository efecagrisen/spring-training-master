...
public class Consume_RestTemplate {
    ...
    public ResponseEntity<User[]> realAllUsers(){
        return restTemplate.getForEntity(URI, User[].class); // getForEntity enables us to modify json body through dto classes
    }
    ...
    public Object readUser(@PathVariable("id")Integer id){
        ...
        return restTemplate.getForObject(URL, Object.class, id); // getForObject do not need dto classes
    }
